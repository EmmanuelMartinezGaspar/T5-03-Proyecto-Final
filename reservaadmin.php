	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(images/fondoadm2.png)">
		...
		<?php 
			...
			require ("conexion2.php");
			 ...
			 ?>
			<a href="agregarA.php"><button class="btn_crear" type="submit">Agrear Nueva Reserva</button></a> 
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="editarA.php?id=<?php echo $fila['id'] ?>">Editar</a>
								<a href="eliminarA.php?id=<?php echo $fila['id'] ?>">Eliminar</a>
							</td>
						</tr>
					<?php } ?>
					</tbody>
